...
export default function ProductRow({ product }: { product: ProductContent }) {
  ...
  return (
    <TableRow className="hover:bg-gray-50 cursor-pointer transition" onClick={goToProduct}>
      {/* Product Cell */}
      ...
      {/* Stock Cell */}
      <TableCell className="w-[90px] px-4 py-5 align-middle">
        <div className="text-sm text-gray-600 whitespace-nowrap">{getStockText(product.stock)}</div>
      </TableCell>
