...
/* ---------------- COMPONENT ---------------- */
export default function EditProductForm({ product }: { product: SingleProduct }) {
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="space-y-1">
          ...
          <div className="text-sm text-gray-500 flex items-center gap-1">
            <Link href="/admin/products" className="hover:text-[#acac49] transition">
              Products
            </Link>

            <span>/</span>

            <span className="font-medium text-gray-900 truncate max-w-60">{product.name}</span>
          </div>
        </div>
      ...
      <div className="grid grid-cols-3 gap-6">
        ...
        <div className="col-span-2 space-y-4">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-4">
            ...
            {/* Description */}
            <div className="space-y-1">
              <label className="text-sm font-medium text-gray-900">Product Description</label>
              <Textarea
                name="description"
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-4">
            ...
            <div className="grid grid-cols-4 gap-3">
              {product.images.map(img => (
                <div key={img} className="relative w-full h-24 rounded-md border overflow-hidden">
                  <Image src={img} alt="product" fill sizes="200px" className="object-cover" />
        ...
        <div className="col-span-1 space-y-4">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-5 space-y-4">
            ...
            <div className="flex items-center justify-between py-2">
              ...
              <ToggleSwitch checked={form.isActive} onChange={handleActiveChange} />
            </div>
