...
import { ProductGridSkeleton, ProductsPageSkeleton } from '@/components/skeleton'
...
export default function ProductsClient({
  ...
  const fetchData = async () => {
    ...
    // Set initial loading only on first fetch
    if (!isInitialized) {
  ...
  return (
    <>
      {/* Show comprehensive skeleton only during initial page load */}
      {isInitialLoading ? (
