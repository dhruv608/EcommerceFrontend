        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center space-x-4">
            <div className="flex items-baseline space-x-2">
              <span className="text-2xl md:text-3xl lg:text-4xl font-black text-primary">₹{product.price}</span>
              <span className="text-sm md:text-base text-muted-foreground line-through">₹{Math.floor(product.price * 1.3)}</span>
            </div>
            <Badge className="badge-danger px-3 py-1 text-xs font-bold">
              30% OFF
            </Badge>
          </div>
        </div>
