...
async function getProducts(
  ...
  if (typeof params.categoryId === 'string') query.append('categoryId', params.categoryId)

  if (typeof params.search === 'string') query.append('search', params.search)

  if (typeof params.minPrice === 'string') query.append('minPrice', params.minPrice)

  if (typeof params.maxPrice === 'string') query.append('maxPrice', params.maxPrice)

  if (typeof params.sortBy === 'string') query.append('sortBy', params.sortBy)

  if (typeof params.direction === 'string') query.append('direction', params.direction)
...
export default async function ProductsPage({
  ...
  const currentCategoryName =
    categories.find(c => c.id.toString() === ((resolvedSearchParams.categoryId as string) || ''))
      ?.name || 'All Collection'
