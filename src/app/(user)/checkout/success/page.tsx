    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/">
            <Button className="bg-[#acac49] hover:bg-[#96963f]">
              Return to Home
            </Button>
          </Link>
        </div>
          ...
          <Card className="text-center p-8 md:p-12">
            <CardContent className="space-y-6">
              ...
              <div className="bg-white rounded-xl shadow-sm p-6 text-left">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{new Date(orderData.orderDate).toLocaleDateString()}</span>
                  </div>
                  
                  <div className="flex justify-between">
                    <span className="text-gray-600">Total Amount:</span>
                    <span className="font-semibold text-lg text-[#acac49]">${orderData.totalAmount.toFixed(2)}</span>
                  </div>
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="bg-[#acac49]/15 text-[#acac49] px-2 py-1 rounded-md text-xs font-medium">{orderData.status}</span>
                  </div>
                  
                  <div className="flex justify-between">
                    <span className="text-gray-600">Estimated Delivery:</span>
                    <span className="font-medium">{estimatedDelivery.toLocaleDateString('en-US', { 
                      weekday: 'long', 
                      year: 'numeric', 
                      month: 'long', 
                      day: 'numeric' 
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link href="/">
                  <Button variant="outline" className="border border-gray-300 text-gray-700 rounded-lg px-6 py-3 hover:bg-gray-50 w-full sm:w-auto">
